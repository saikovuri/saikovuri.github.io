...
if(isset($_POST['email'])) {
    ...
    $email_to = "saikovuri367@gmail.com";
    ...
    $emailsubject = $_POST['contactSubject']; // required
 
    $comments = $_POST['contactMessage']; // not required
  ...
  if(!preg_match($string_exp,$emailsubject)) {
 
    $error_message .= 'Please mention the subject line.<br />';
